<%@ Page Title="Agregar Alquiler" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="AgregarAlquiler.aspx.cs" Inherits="Vista_Web.Alquileres.AgregarAlquiler" %>
                ...
                <div runat="server" class="row">
                    <div runat="server" class="col-lg-12">
                        <div class="page-header" title="Gestión de Usuarios">
                            <h1>Agregar Alquiler <small>Módulo Alquileres</small></h1>
                        </div>
                    </div>
