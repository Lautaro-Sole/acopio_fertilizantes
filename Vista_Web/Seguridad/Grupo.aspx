<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Grupo.aspx.cs" Inherits="Vista_Web.Seguridad.Grupo" %>
                            ...
                            <div class="tab-pane fade active in" id="datos">
                                <div class="form-horizontal" role="form">
                                    <div class="form-group">
                                        ...
                                        <label for="txt_codigo" class="col-sm-4 control-label">Código del grupo:</label>
                                        <div class="col-sm-8">
                            ...
                            <div class="tab-pane fade" id="permisos">
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <label class="col-sm-4 control-label">Los permisos solo se pueden modificar desde la gestión de perfiles</label>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </div>
