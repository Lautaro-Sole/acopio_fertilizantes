                    ...
                    <div runat="server" class="col-lg-12">
                        ...
                        <div class="tab-pane fade active in" id="alquiler">
                            <div class="form-horizontal" role="form">
                                    <label  for="txt_capacidadlibreminima" class="control-label">Capacidad libre minima <br />
                        ...
                        <div class="col-lg-4" id="documento">
                                <div class="form-vertical" role="form">
                                    <div class="form-group">
                                        ...
                                        <label for="txt_cantidadenkg" class="control-label">Cantidad (en KG) <br /> </label>
