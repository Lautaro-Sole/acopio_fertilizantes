<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="AutorizarCierre.aspx.cs" Inherits="Vista_Web.Operaciones.AutorizarCierre" %>
                ...
                <div runat="server" class="row">
                    <div runat="server" class="col-lg-12">
                        <div class="page-header">
                            <h1>Autorizar cierre <small title="Autorizar cierre">Módulo de Operaciones</small></h1>
                        </div>
                    </div>
                    ...
                    <div id="Div4" runat="server" class="form-group">
                     ...
                     <div id="Div5" runat="server" class="form-group">
                         <label runat="server" for="cmb_estado">Estado</label>
